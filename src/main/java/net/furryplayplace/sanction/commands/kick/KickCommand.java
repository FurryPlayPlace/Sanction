...
package net.furryplayplace.sanction.commands.kick;
...
public class KickCommand extends AbstractCommand {
    ...
    public KickCommand(Sanction plugin) {
        super("kick", true, "moderation.kick");
        this.plugin = plugin;
    }
    ...
    public int execute(CommandContext<ServerCommandSource> context, ServerPlayerEntity sender, String[] args) {
        ...
        this.plugin.moderationManager().kickPlayer(target, reason, sender);
        return 1;
    }
